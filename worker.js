...
3. oem_results present + buyer gave TP → MANDATORY BILL EXT PRE-CHECK: count exact-match oem rows (case-insensitive MPN match). If ALL of those rows have "BILL EXT" in notes → go to rule 3b immediately. Only if at least one exact-match row has NO "BILL EXT" in notes → msg_checking.
