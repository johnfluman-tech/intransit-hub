...
0b. in_stock_results present where ALL rows have "Warehouse#" in their notes field (any external warehouse: Warehouse#3, Warehouse#4, etc.) + stan_results has a row with status "QUOTED" → stan_quoted. A row is external-warehouse if notes contains "Warehouse#". own_stock is ONLY for rows where notes do NOT contain "Warehouse#".
