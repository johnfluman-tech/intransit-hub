...
TP can appear in many formats — always recognize these as an explicit buyer target price: "TP$3.5", "TP $3.5", "target price $3.5", "$3.5 each", "$3.5/pc", "$3.5 per piece", "3.5 USD", "USD 3.5", "1.05u", "our budget is $X", "we can pay $X". Never ask for a TP when any of these patterns are present.
